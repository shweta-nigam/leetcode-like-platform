...
const navigate = useNavigate();
 ...
 <div className="h-screen grid lg:grid-cols-2 bg-gray-950 text-white">
  <div className="flex flex-col justify-center items-center p-6 sm:p-12">
    <div className="w-full max-w-md space-y-8 glass-card border border-primary/10 p-6 sm:p-8 rounded-xl shadow-lg">
      {/* Logo Section */}
      <div className="text-center mb-8">
        <div className="flex flex-col items-center gap-2 group">
          ...
          <p className="text-sm text-gray-400">Sign up to your account</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        {/* Submit Button */}
        <button type="submit" className="my-g-btns btn btn-primary w-full " disabled={isSigninUp}>
          {isSigninUp ? (
            <>
